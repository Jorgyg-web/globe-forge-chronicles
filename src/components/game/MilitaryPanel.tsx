...
import { ArmyTooltipContent, UnitTooltipContent } from '@/components/game/tooltips/GameTooltipContents';
      ...
      <div className="game-panel">
        ...
        <div className="divide-y divide-border/20">
          ...
          {myArmies.map(army => {
            ...
            return (
              <StrategyTooltipProvider key={army.id}>
                <StrategyTooltip>
                  <StrategyTooltipTrigger asChild>
                    <div className={`p-2.5 transition-colors ${isSelected ? 'bg-primary/5' : 'hover:bg-muted/30'}`}>
                      <div className="flex items-center justify-between mb-1 cursor-pointer"
                        onClick={() => {
                          setExpandedArmy(isExpanded ? null : army.id);
                  ...
                  <StrategyTooltipContent side="right" align="start">
                    <ArmyTooltipContent army={army} province={currentProv} country={country} />
          ...
          {availableUnits.map(type => {
            ...
            return (
              <StrategyTooltipProvider key={type}>
                <StrategyTooltip>
                  <StrategyTooltipTrigger asChild>
                    <div className="p-2.5 hover:bg-muted/30 transition-colors">
                  ...
                  <StrategyTooltipContent side="right" align="start">
                    <UnitTooltipContent unitType={type} count={inArmyCount} />
                  </StrategyTooltipContent>
                </StrategyTooltip>
              </StrategyTooltipProvider>
            );
